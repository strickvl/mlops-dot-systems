...
image: fastai-lesson-9/sd-dutch-nn.png
layout: post
...
_(This is part of a series of blog posts relating to and responding to the live FastAI course (part 2) being taught October-December 2022. To read others, see the ones listed for [the 'parttwo' tag](/technical.html#category=parttwo).)_
...
![](fastai-lesson-9/sd-dutch-nn.png "This used the prompt 'a Dutch male AI researcher trying to understand how neural networks work. looking at a computer screen on his desk'")
