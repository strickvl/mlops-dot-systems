...
categories:
  ...
  - ecology
date: "2016-10-28"
description: "Switching from Dreamhost to GreenGeeks to reduce my technological footprint, and what I learned about carbon offsetting in the web hosting industry."
layout: post
...
A small, but not insignificant, service I rely on is web servers, domain hosting and the like. I had been a loyal [Dreamhost](https://www.dreamhost.com/) customer for many years and have had no reason to complain about their services. Cheap, fast, and their web panel does everything you’d want from it.

So why should you care about your internet server’s ecological footprint? Because small things matter and because the internet [is no small thing](http://www.nytimes.com/2012/09/23/technology/data-centers-waste-vast-amounts-of-energy-belying-industry-image.html). In fact, some reports project the infrastructure of the internet to be as big a polluter as the airline industry by 2020.

I started looking into Dreamhost’s green credentials and at first glance there’s no real reason to make any changes. [From their website](https://www.dreamhost.com/company/were-green/):
...
Moreover, GreekGeeks are a whole lot more environmentally-friendly than Dreamhost, it turns out. For every unit of energy consumed by their servers/customers, they invest in green companies and green energy sources [three times over](https://www.greengeeks.com/kb/4584/greenest-web-hosting-on-the-planet/):
...
If you’re currently using web hosting of some sort, I’d encourage you to check out [GreenGeeks](https://www.greengeeks.com/track/strickvl/cp-default) or some other eco-friendly option.
