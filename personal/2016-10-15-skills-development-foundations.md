...
categories:
  ...
  - skills
date: "2016-10-15"
description: "My notes on Allison Kaptur's talk about effective learning strategies, covering growth mindset, deliberate practice, and how to approach skill development in unstructured environments."
layout: post
...
Or just read these notes to get an overview of some useful things she talks about. (If you want to read a transcript, [go here](http://akaptur.com/blog/2015/10/10/effective-learning-strategies-for-programmers/).)

**“Allison Kaptur: Effective Learning for Programmers” — Notes from YouTube**

We learn early on that Kaptur’s job at the [Recurse Center](https://www.recurse.com/) was to help and support students grow and learn amidst the freedom that the programme there afforded them. This kind of unstructured environment can come as a shock if you’ve only been able to work in structured settings in the past (schools, universities, big companies etc). The unstructured freedom to which Kaptur refers around the [1:30](https://youtu.be/Mcc6JEhDSpo?t=1m31s) mark also happens to be a hallmark that defines self-study work.

**“Growth Mindset”**

- Kaptur introduces the work of sociologist [Carol Dweck](https://en.wikipedia.org/wiki/Carol_Dweck) and the distinction she’s drawn between fixed mindsets and growth mindsets.
...
- Kaptur mentions how Dweck’s work has also shown that people who are praised for their effort in the task being performed tend to get better results [slight simplification of what she said] than those who are praised for what they achieved. This is [a fairly well-known and well-publicised aspect](http://www.nytimes.com/1998/07/14/science/praise-children-for-effort-not-intelligence-study-says.html?_r=0) of Dweck’s work.
- Kaptur notes that having a fixed vs growth mindset is something which (it seems) can be changed. And the switch from fixed to growth mindset can sometimes [happen with deceptively easy tactics](https://youtu.be/Mcc6JEhDSpo?t=11m23s).
...
- On Confidence & Imposter Syndrome
  ...
  - The trick to getting past all of this (of course) is to adopt a growth mindset. ([20:10](https://youtu.be/Mcc6JEhDSpo?t=20m10s))
...
- “Make It Stick” — Kaptur offers some useful tips that she gathered from this great book. You can read my review [here](https://www.goodreads.com/review/show/1293275912?book_show_action=false), in which I also extract some of my favourite actionable points.
  - “Learning is an acquired skill” — the premise of the book
  - 1) “Effortful retrieval > rereading” — this can be something like self-tests administered through [Anki](http://ankisrs.net/), or it can just be writing a review of a book after you’ve read it. Or it could be trying to summarise a recently-mastered topic by teaching it to someone else.
...
2. take guesses
3. be systematic about how you attack your problems. She is speaking in the context of programming, so [she talks about debugging](https://youtu.be/Mcc6JEhDSpo?t=29m25s) but it works for most problems. Have a hypothesis about what’s going wrong, and then tackle each part systematically.
