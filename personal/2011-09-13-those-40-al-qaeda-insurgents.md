...
categories:
  ...
  - journalism
date: "2011-09-13"
description: "A critical examination of how ISAF press releases inflate al-Qaeda numbers in Afghanistan, with analysis of military operations tallied against the actual evidence presented in official statements."
layout: post
...
I've been working on a report for the [Afghanistan Analysts Network](http://www.aan-afghanistan.com/ "Afghanistan Analysts Network") relating to ISAF's press releases these past few months, as those of you [following me](http://www.twitter.com/strickvl/) on twitter will already know. A pleasant byproduct of that research is the database of press releases that I've put together, one that allows me to isolate, for example, all the instances where ISAF went after someone they thought was associated or affiliated with al-Qaeda in some way.
...
Note first of all, that the numbers don't even reach the minimum '40' claimed in the press release, EVEN if we assume that all those listed were 'al-Qaeda insurgents'. As Bill rightly notes in [his post](http://www.longwarjournal.org/threat-matrix/archives/2011/09/how_many_al_qaeda_fighters_are.php), "what is the intelligence community and the military's definition of al Qaeda?" A lot of the people in the list above will have been Afghans, and many are simply noted as having been 'suspected ties'.
...
Photo Credit: © [Philip Poupin](http://www.philip-photos.com/ "Philip Poupin")
