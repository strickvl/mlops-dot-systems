...
categories:
  ...
  - learning
date: "2015-09-02"
description: "Practical tips and reflections on my experience attending Middlebury's eight-week intensive Arabic summer programme, including how to make the most of the language pledge immersion."
layout: post
...
**[UPDATE 2: (Jan 2017) I've just finished writing a new book, *Master Arabic*, on getting from an intermediate level in Arabic to advanced. [Read more here](http://languagecoach.io/masterarabic).]**
...
If you’re a complete beginner, there’s still a lot of value in doing some work before the programme starts. A lot of the things you do in the early days of learning Arabic are somewhat menial (learning the alphabet, practicing pronunciation and some of the unique sounds that Arabic uses, and so on) and there’s no real reason why you can’t have this all in the bag before you start formally with the Middlebury programme. If you’re extra enthusiastic, you could learn a bunch of basic phrases that you’ll always need to use — perhaps [start with this list](http://www.omniglot.com/language/phrases/arabic.php) — and/or learn the first 500-2000 (depending on your bravery) words in the Arabic frequency list. Either use the versions over at [Memrise](http://www.memrise.com/course/364774/1-1000-arabic-frequency-audio-no-typing/) or [Anki](https://ankiweb.net/shared/info/588996094) for this (both are "no-typing" courses, with audio, I think, so they should be ok for those who’ve just learnt the alphabet). And for a true bonus, pick a teacher over at [iTalki](http://www.italki.com/?ref=1021142) and do an easy 30-45 minute lesson every week or two in the winter/spring months before the summer.
...
- spoken practice via [iTalki](http://www.italki.com/?ref=1021142) or some other language exchange site/programme (shout-out to the newcomer [Natakallam](http://natakallam.com/), which pairs Syrian refugees in Lebanon with Arabic learners, benefitting both parties). From January-early June I was doing 4-5 hours of iTalki lessons every week (an hour session almost every weekday)
- writing practice over at Lang-8 (I’ve written about this [before](http://www.alexstrick.com/a-different-place/2013/01/a-jedi-mind-trick-and-three-other-approaches-to-learning-vocabulary), but basically you write entries (about anything) and people correct them for you in exchange for you correcting things in your native language (presumably English)).
- reading practice — I read through all the Sahlawayhi books from January-June. In case you haven’t heard of [this excellent series of graded readers](http://www.amazon.com/s/ref=nb_sb_noss_2?url=search-alias%253Dstripbooks&tag=soumet-20&field-keywords=sahlawayhi) for beginning-intermediate levels (and [their paired audiobooks](http://www.audible.com/search/ref=a_hp_tseft?advsearchKeywords=sahlawayhi&filterby=field-keywords&x=0&y=0&sprefixRefmarker=nb_sb_ss_i_0_4&sprefix=sahl)), you’re really missing out. The stories are quirky, and not so difficult that you’re looking up every other word in [good ol’ Hans Wehr](http://www.ejtaal.net/). Even if the language level in the final levels is beyond what you’re capable of, there’s still lots to devour in the early books. Strongly recommended, though this isn’t really for absolute beginners.
...
- (typing practice - this one’s optional, but given how much you’ll find yourself having to type, I’d strongly recommend you practice this and get comfortable finding your way around the keyboard prior to attending the course, especially at the higher levels where you have to write dissertations of 2000+ words in Arabic (typed, of course). I don’t know of many options for PC-users, but for Mac users you can check out [XType (on the Mac App Store)](https://itunes.apple.com/us/app/xtype-addictive-typing-tutor!/id480526384?mt=12) for a structured lesson plan for learning typing using the Arabic alphabet. There’s also [Typing Master Arabic](http://www.typingmasterarabic.com/) available online, but it’s a 100% Arabic-only course so that may or may not be appropriate for you.)
...
Try where possible to [do the unpleasant / necessary thing now](http://joeltimothy.com/swallow-a-frog/) so as not to have to do it later. The Middlebury Arabic programme does not really work well with any kind of procrastination behaviour. Enough said on that.
...
The students of level 4.5 learnt around 3000 new words during the eight weeks of the programme. This doesn’t include words learnt while reading the assigned novel (see below), but I know it’s roughly 3000 because I have them all entered into [Anki](http://ankisrs.net/) and I can see exactly how many times I’ve reviewed each one and so on.
...
I could not have done it without [spaced-repetition](http://www.gwern.net/Spaced%20repetition) and my faithful [Anki](http://ankisrs.net/).

If you want to ensure that you’re not panicking every time there’s a weekly vocabulary test, and (more importantly) if you want to make sure that you’ll have a way to keep learning and reviewing the things you learnt while on the Middlebury programme, you have to use [some sort of spaced-repetition software](https://en.wikipedia.org/wiki/Spaced_repetition#Software). I really don’t see any other way.

Again, I’ve [written about spaced-repetition elsewhere](http://www.alexstrick.com/a-different-place/2013/01/a-jedi-mind-trick-and-three-other-approaches-to-learning-vocabulary) so go check that out and then come back.

So now you know that Anki is basically a flash-card programme, one that presents words for review at exactly the right time so you’re not needlessly studying, reviewing and testing yourself on things that you know pretty well. As I said earlier, if you aren’t embracing some sort of software-based approach to storing the things you learn on the course, you’ll just forget it over the months after you leave the programme in which case, why did you pay [$13,000](http://www.middlebury.edu/ls/arabic/dates_fees) to attend in the first place?

So, to put you in my shoes, every day we’d study new texts, listen to things, write things and sometimes even get vocab lists themselves. Lots of input. After class each day, I’d take an hour (sometimes up to two) inputting the new bits of information into [Anki](http://ankisrs.net/) to ensure that I can keep reviewing things during the course without stressing about which words to devote the most time to, and so on.
...
(By the way, this method of 100% target-language-only cards, and the formatting of the cards and a lot of the 'system' I’m describing here draws heavily on the system described by Gabriel Wyner in [his fantastic CreativeLive course](https://www.creativelive.com/courses/become-fluent-any-language-gabriel-wyner) on learning languages. I’ve recommended that in the past, too.)
...
The night before tests, I would often see people around campus ['cramming'](https://www.youtube.com/watch?v=MKYMxo-WIpI) words, and the next morning I’d hear about how they were studying until 4am and so on. This is not a recipe for success in the long-term. This won’t help you retain the words after the course ends.
...
I \_\_ to the supermarket last week.
...
Again, I’d make sure I wrote sample sentences practicing the grammar points under discussion and those would (post-corrections) make their way into Anki. If there were lists of things to be learnt — the seven forms of the *siffa mushabahha*, for example — I’d make a card that asks me for those seven forms, then I’d pick sample words in those verbal forms, then add them to a [memory palace](http://mt.artofmemory.com/wiki/Method_of_Loci), and then the Anki system would keep reviewing my command of those seven forms. (Don’t worry if the details of what I just wrote were incomprehensible; just take away the fact that I was finding ways to test myself on the grammar we learned, in abstract form (i.e. a list of the forms) as well as in applied form (sample sentences using the things I’ve learned in real-world context).

# Readings

Another thing the Middlebury course — like any decent language programme — includes a lot of is reading. Where possible, I used [Steve Ridout](http://steveridout.com/about/)’s excellent online service called [Readlang](http://readlang.com/).

I’ll let Steve [explain the overall principle](https://www.youtube.com/watch?v=ntVQ2L5s6FI):
...
There are some slight amendments I’d recommend for Arabic-learners. If you go to [your account settings](http://readlang.com/preferences) you’ll have the opportunity to enter in details for a custom Arabic dictionary. Delete whatever is the default there at the moment (probably Google) and use the following text to refill the form.
...
I don’t have too much to say about these. If your colloquial class teaches you a lot of new words, make sure to add them all to Anki and review as appropriate. You’ll probably have to pronounce the words yourself when making new cards — [this explains the basics of how to do that](http://japaneselevelup.com/boosting-ankis-power-with-media-enhancements-2-audio/) — so make sure to make annotations on class handouts as to the vocalisation of the words (i.e. the vowelling) so that you’re not mispronouncing.

# The Novel

We read Tayyib Saleh’s *Mawsim al-hijra illa al-shomal* (['Season of Migration to the North’](http://www.amazon.com/Season-Migration-North-Review-Classics/dp/1590173023/ref=sr_1_1?sr=8-1&qid=1441191162&keywords=seasons%2Bof%2Bmigration&tag=soumet-20&ie=UTF8&perid=153B564JPP7S7K3N4BKX&pebp=1441191166810)) over the course of the eight-week programme. It’s not particularly long, but the language used is difficult, especially in terms of the huge number of new words.
...
I used [Readlang](http://www.readlang.com) (along with [a copy of the original Arabic text](http://albrkal.com/vb/archive/index.php/t-84.html) of the novel) to read the assigned chapters each week. That way I wasn’t spending all my time looking words up in Hans Wehr. The number of new/unknown words made that an untenable prospect.
...
- [Context-Reverso](file:///var/folders/m_/_hl8pmsn1yj_06sckdldzmsm0000gn/T/com.soulmen.ulysses3/a49b5c3e644644bf8396ba0a1fe6b9d2/Introduction/context.reverso.net) — I have one of my fellow classmates to thank (Hi Yasmine!) for this gem. You put in a word, and it spits out example sentences (drawn from a big database of sample real-word texts) using that word in context. For the intermediate-advanced learner, it’s an amazing resource, far more useful than Google Translate or any others of its kind.
- [iTalki](http://www.italki.com/?ref=1021142) — I mentioned this above, especially in the context of your preparations for study at Middlebury. I also (where classmates were off campus on weekends, or in order to prepare for oral presentations and so on) scheduled one or two lessons during the programme itself so that I could talk through my ideas, or a difficult piece of text etc, with my teacher over Skype.
- [Lang-8](http://lang-8.com/) - I mentioned this above. Use it. Love it. Share it.
- [Electronic Hans Wehr](http://www.ejtaal.net/) — You can search the Hans Wehr dictionary online by root.
- [Forvo](http://www.forvo.com/) — great for getting audio pronunciation of words for use in your Anki deck.
