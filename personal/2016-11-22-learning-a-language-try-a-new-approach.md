...
categories:
  ...
  - pashto
date: "2016-11-22"
description: "A reflection on twenty-five years of language learning and the different approaches I've tried—from vocabulary-heavy methods to immersion programs, online courses, and speaking with native speakers."
layout: post
...
- speak from day one — I tried this with Japanese, where the emphasis is on talking to people (in my case, various [iTalki](https://www.italki.com/i/fHDd6) teachers) even though it’s still too early to be having long conversations
...
- learning online via a computer-driven course — I’ve studied French, German and Turkish via [Duolingo](https://www.duolingo.com/)
- writing lots — I use [Lang-8](http://lang-8.com/) to get corrections on materials
- speaking lots — [iTalki](https://www.italki.com/i/fHDd6) is the best option for this (cheap lessons, usually great teachers / conversation partners)
- listening to lots / watching lots — I’ve used [Beeminder](https://www.beeminder.com) to set myself input / consumption goals for most of my recent languages
- learning lists of key phrases — this helped a lot with Japanese at the beginning
- learning using listen-and-repeat audio courses — [Michel Thomas](http://www.michelthomas.com/) and [Pimsleur](http://www.pimsleur.com/) are the best known and gold-standard for this kind of thing. If the language you’re learning is available for either of those, it’s probably worth just doing the entire course before you start your formal study.
