...
categories:
  ...
  - knitting
date: "2025-01-05"
description: "Starting my knitting journey: reflections on early practice swatches from the TKGA correspondence course, including garter stitch, stockinette, and rib patterns."
layout: post
title: "First stitches: on learning to knit"
toc: true
aliases:
  - "/blog/first-stitches-on-learning-to-knit.html"
...
I previously learned how to crochet. I never made anything too fancy or intricate but it was an easy way to make beautiful presents for special occasions or individuals. This past christmas we decided that presents could only be exchanged if they were handmade. Cue: hours of double crochet to make [a jumper](https://www.ravelry.com/projects/strickvl/devotion-jumper), [a snood](https://www.ravelry.com/projects/strickvl/cherish-snood) and some embroidery of [Ramallah *tatreez* patterns](https://www.folkglory.com/shop/p/palestine-ramallah-embroidery-kit). Along the way I discovered Elise's [Purls Before Thyme channel](https://www.youtube.com/@purlsbeforethyme.) over on YouTube, devoured all the videos and got the idea that maybe I might want to try knitting.

What follows is mostly some self-reflection on some of the first practice swatches I made as part of [The Knitting Guild Association](https://tkga.org/) (TKGA)'s [Learn to Knit correspondence course](https://tkga.org/education/correspondence-courses/). I also want a bit of a record of my progress since [Ravelry](https://ravelry.com/) isn't really a place for logging swatches.
...
The yellow-ish yarn I used for this was [Lana Grossa Cool Merino](https://www.ravelry.com/people/strickvl/stash/cool-merino) which is bound or woven (?) in a sort of chain as its internal structure. This means it doesn't split, but it *does* offer many small holes that you might accidentally end up passing your needle through. Lesson learned!

## Single and Double Rib
...
## Increases, decreases and yarnovers
...
Down the line, and depending on how the feedback from my first swatches goes, I'd like to maybe try some other courses and perhaps even the [Master Hand Knitting certification](https://tkga.org/certification/master-hand-knitting/). I'll also be dipping into the [Fearless Knitting Workbook](https://www.amazon.com/Fearless-Knitting-Workbook-Jennifer-Seiffert/dp/1596681497) which is also swatch-based, a format I've been really enjoying as it allows me to get fast feedback and improve my skills.
