...
categories:
  ...
  - education
date: "2023-08-06"
description: "Reflections on studying effectively at school, with advice I wish I'd known earlier—covering how to learn for understanding, study strategies for exams, and specific tips for mastering mathematics."
layout: post
...
(There's [a much-praised technique](https://collegeinfogeek.com/feynman-technique/) named after a well-known American scientist, Richard Feynman, and you can do something like this, too:
...
Things like [the major system](https://en.wikipedia.org/wiki/Mnemonic_major_system), [the link system](https://en.wikipedia.org/wiki/Mnemonic_link_system) and [the peg system](https://en.wikipedia.org/wiki/Mnemonic_peg_system) are all useful, but they require a bit of time and probably also someone who knows how they work to explain them to you.
