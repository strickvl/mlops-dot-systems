...
categories:
  ...
  - useful-tools
date: "2014-09-05"
description: "I created an Anki deck from a 1969 Urdu frequency dictionary, complete with audio pronunciations for nearly 10,000 words."
layout: post
...
Readers of my [previous](https://alex-strickvanlinschoten-rc2y.squarespace.com/a-different-place/2013/01/5-things-i-wish-someone-had-told-me-about-learning-languages) language [posts](https://alex-strickvanlinschoten-rc2y.squarespace.com/a-different-place/2013/01/a-jedi-mind-trick-and-three-other-approaches-to-learning-vocabulary) will know about [Anki](http://ankisrs.net/). For those who don't know, it's basically software that allows you to memorise pieces of information (such as foreign language vocabulary).
...
I had someone type up the whole dictionary into Anki and add a spoken audio file for every word. (Many thanks to [Affan Ahmad](https://www.elance.com/s/munna024/) for this massive labour.) You can even set Anki to deliver you words randomly served from the frequency dictionary.

So, without any further ado, the files are [here](https://web.tresorit.com/l/xNNIF#0-r38KOSpn6ha0M76GWTnQ). They are split up because Anki became a bit difficult when inputting the files, but you can combine them on your own computer into a single "Urdu" folder.
