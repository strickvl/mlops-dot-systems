...
categories:
  ...
  - launchschool
date: "2019-02-16"
description: "Reflections on study habits I've developed while working through a coding bootcamp curriculum, with emphasis on core principles like mastering fundamentals, focusing on process over goals, and cultivating a growth mindset."
layout: post
...
This is especially true for things that I’m not fully comfortable with. For something where I have thousands of hours of experience under my belt — [the modern political history of Afghanistan, let’s say](https://www.amazon.com/Enemy-We-Created-Taliban-Al-Afghanistan-ebook/dp/B008PPWB18/ref=sr_1_1?sr=8-1&keywords=alex%2Bstrick%2Bvan%2BLinschoten&s=gateway&tag=soumet-20&qid=1549842748) — I have more of a structure in my head and so can get away with typing notes. For the rest, like all these new things I’m learning about Ruby, pen and paper is pretty unbeatable. There’s a bunch of [good science](https://www.medicaldaily.com/why-using-pen-and-paper-not-laptops-boosts-memory-writing-notes-helps-recall-concepts-ability-268770) confirming that that’s the case, and it aligns with my experiential sense as well.

Some people in the forums noted how one of their preparatory tasks prior to an assessment was to type up their handwritten notes into a more formal digital reference of the course materials. I’m in two minds as to whether I think that’s going to be useful, mainly because [the online documentation](https://ruby-doc.org/core-2.4.4/) exists to serve that purpose. But I’m at the point where I have to decide about that so watch this space…

- Anki for things you need to remember

If I think a particular method / fact / morsel of knowledge is something I’m going to want to actively recall from memory in the future, I’ll add it to [Anki](https://apps.ankiweb.net/). I try to follow the principles outlined in Piotr Wozniak’s essential piece entitled “[Twenty rules of formulating knowledge](http://super-memory.com/articles/20rules.htm)”. (Seriously if you use Anki and you haven’t read it, stop right now and go read it).
...
I use a slight variant of this [much](https://fs.blog/2012/04/feynman-technique/)-[lauded](https://collegeinfogeek.com/feynman-technique/) [technique](https://lemongrad.com/feynman-technique/). It consists of something approximate to the following steps:
...
[My last blog post](https://www.alexstrick.com/blog/ruby-zip) is an illustration of this. I was having trouble getting what the `.zip` method could be used for and how it transformed things to which it was applied. So I wrote up some notes to myself in the form of a blog post.

I sometimes worry that too many of these posts — written purely for me to understand something — are alienating for those who subscribe to the blog via something intrusive like [the email newsletter](https://alexstrick.us2.list-manage.com/subscribe/post?u=95ede971ea04215e1c027c6cb&id=2acaad0357). I considered putting my ‘writing for the purposes of understanding’ posts in a separate location. In the end, though, I’m probably overthinking it. Like it or lump it!
...
As evidenced by the large number of cards in my [Anki](https://apps.ankiweb.net/) deck, Anki occupies a central place in my strategy to outsource the need to worry about reviews and recall over the long-term. If there’s something I want to be able to recall a year from now and it’s not something I’m using literally every day or two, then it’s going to end up in Anki.
...
The great thing about Anki is that as a particular fact passes from your short term memory to your long-term memory, the need for reviews becomes less frequent, so you’ll see it less often. Trust the [spaced repetition algorithm](https://www.spacedrepfoundation.org/). It knows what it’s doing.
...
- Use [the rubber ducky method](https://blog.codinghorror.com/rubber-duck-problem-solving/) of talking through a problem. (This can be translated to writing as well, where just the act of writing up where you’re stuck can often be enough to get you unstuck)
- Don’t cheat yourself of the opportunity to learn if the problem is difficult. Work through it and take your time.
- Use the [PEDAC system / process](https://launchschool.com/blog/the-two-layer-problem)
...
I covered this above a little, but basically for me it means using tools like [Freedom](https://freedom.to/) and [Focus](https://heyfocus.com/) apps to keep me honest and not distracted. I’m fairly good about using these tools, but not always and it’s easy to notice the difference.

- Take breaks

I usually segment my studies with inbuilt short breaks. These can be anywhere from 5-10 minutes and I try to get up, stretch or do some kind of physical exercise / movement. For Macs, the [Move!](https://christiantietze.de/move-work-break/) app is a great utility. I like to take somewhere between one and two breaks per hour on average.

- Think about posture early on

This is something which I haven’t thought too much about, but people on the Launch School slack channel and elsewhere have suggested it’s important. If you’re going to spend hours behind some sort of laptop, getting posture and ergonomics right seems like a good thing to aim for. I’ve had good experiences with the [Ninja Standing Desk](https://www.kickstarter.com/projects/1886278358/ninja-standing-desk) (sadly not being produced any more, it seems!) though I don’t currently have it with me. This is something to return to in a few months.
