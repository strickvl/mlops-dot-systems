...
categories:
  ...
  - phdtoolsseries
date: "2016-09-12"
description: "How I used the Pomodoro Technique and Vitamin-R to build focused work sessions during my PhD."
layout: post
...
Another advantage to pomodoros is that they are small enough to appear unthreatening to [your emotional lizard brain](http://99u.com/videos/5822/seth-godin-quieting-the-lizard-brain). Confronted with two options (either working for 25 minutes on a particular problem, or an unboxed task instruction to 'complete this particular task') I know I feel far more comfortable taking a bash at starting to work if I just have to get through 25 minutes. If I place the entire responsibility and expectation of completing a section or a problem from the outset, I'm far more likely to find ways to avoid starting, to procrastinate (even if everything is switched off and I have no access to the internet; it's amazing how creative the mind can be at avoiding hunkering down and tackling a difficult task).

There are many (many) pomodoro timers available online. FWIW, the ones that I've used and found work well for me are: [FocusTime](http://focustimeapp.com/), [PomoDone](http://pomodoneapp.com/) (which hooks into [Trello](/blog?tag=trello) boards).

Around the time when I started my routine of 'Four Perfect Hours' each day, I discovered something called [Vitamin-R](http://www.publicspace.net/Vitamin-R/). This is probably overkill for many of you, but if you're inclined to monitor your data and your stats and your progress, then it might be worth exploring.
